...
public class ModifyProduct implements ActionListener {
	...
	private JTextField datasprz, produkt, ilosc, cenaszt;
	
	private JFrame frame;
	
	private String ID, data, prod, ilos, cena;

	private Jack link;
	
	public ModifyProduct(String ID, String data, String prod, String ilos, String cena, Jack link) {//()
		...
		frame.setTitle("Modyfikuj produkt");
		...
		labRef = new JLabel("Data sprzeda¿y:");
		labRef.setFont(new Font("Comic Sans MS", Font.BOLD, 17));
		
		panRef.add(labRef);
 
		datasprz = new JTextField();
		datasprz.setPreferredSize(new Dimension(200,30));
		panRef.add(datasprz);
		...
		datasprz.setText(data);
		produkt.setText(prod);
		ilosc.setText(ilos);
		cenaszt.setText(cena);
